...
class AdcolonyVideo {
    ...
    fun init(activity: Activity) {
        AdColony.configure(activity, "appdd6513b4a8ba41e8a5", "vzc04eeba9adad451680")
    ...
    fun onResume(activity: Activity) {
        if (adcolonyVideo == null || adcolonyVideo!!.isExpired) {
            AdColony.requestInterstitial("vzc04eeba9adad451680",
                ...
                override fun onExpiring(ad: AdColonyInterstitial?) {
                    super.onExpiring(ad)
                    AdColony.requestInterstitial("vzc04eeba9adad451680", this)
                }
            })
        }
    }
